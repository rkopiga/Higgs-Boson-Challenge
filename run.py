...
if params.LOCAL_PREDICTION:
    ...
    y_test_preprocessed, tX_test_preprocessed, ids_test_preprocessed, masks_test, counts_test = prep.preprocess(y_test,
                                                                                                           tX_test,
                                                                                                           ids_test)
    ...
    optimal_ws = pred.find_optimal_ws_grouped(tX_test_improved, y_test_preprocessed, params.IMPLEMENTATION, log_initial_ws,
